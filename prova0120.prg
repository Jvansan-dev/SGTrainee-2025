...
@11,19 get nFaltaB1        picture "999" valid nFaltaA1 >= 0 .and. nFaltaA1 <= 364
@11,23 get nNotaB2         picture "999" valid nNotaA2 >= 0 .and.  nNotaA2 <= 100
@11,27 get nFaltaB2        picture "999" valid nFaltaA2 >= 0 .and. nFaltaA2 <= 364
@11,31 get nNotaB3         picture "999" valid nNotaA3 >= 0 .and.  nNotaA3 <= 100
@11,35 get nFaltaB3        picture "999" valid nFaltaA3 >= 0 .and. nFaltaA3 <= 364
@11,39 get nNotaB4         picture "999" valid nNotaA4 >= 0 .and.  nNotaA4 <= 100
...
@12,19 get nFaltaC1        picture "999" valid nFaltaA1 >= 0 .and. nFaltaA1 <= 364
@12,23 get nNotaC2         picture "999" valid nNotaA2 >= 0 .and.  nNotaA2 <= 100
@12,27 get nFaltaC2        picture "999" valid nFaltaA2 >= 0 .and. nFaltaA2 <= 364
@12,31 get nNotaC3         picture "999" valid nNotaA3 >= 0 .and.  nNotaA3 <= 100
@12,35 get nFaltaC3        picture "999" valid nFaltaA3 >= 0 .and. nFaltaA3 <= 364
@12,39 get nNotaC4         picture "999" valid nNotaA4 >= 0 .and.  nNotaA4 <= 100
